...
const _EPS = 0.000001;
const _STATE = { NONE: - 1, ROTATE: 0, ZOOM: 1, PAN: 2, TOUCH_ROTATE: 3, TOUCH_ZOOM_PAN: 4, RESET_VIEW: 5 };
...
class TrackballControls extends Controls {
	...
	constructor( object, domElement = null ) {
		 ...
		 */
		// 마우스 버튼 매핑 변경
		this.mouseButtons = { LEFT: MOUSE.PAN, MIDDLE: MOUSE.RESET_VIEW, RIGHT: MOUSE.ROTATE };
...
function onMouseDown( event ) {
	...
	switch ( mouseAction ) {
		...
		case MOUSE.RESET_VIEW:
			this.state = _STATE.RESET_VIEW;
			this.reset(); // 시점 가운데로 리셋 기능 추가
			break;
